            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2">São Sebastião, nascido no século III em Narbonne, traz consigo a herança de Milão. Sua vida é marcada por uma generosidade intrínseca e uma ascensão impressionante de soldado a primeiro capitão da guarda imperial no Império Romano.<br><br>No entanto, sua verdadeira grandeza se manifesta durante a perseguição de Diocleciano, quando ele defende secretamente os cristãos, oferecendo conforto e testemunho silencioso de fé<br><br>Diante do martírio, sua coragem inabalável e sua devoção indomável em meio à adversidade continuam a ressoar como um exemplo duradouro de sacrifício e devoção.</p>
                    </div>
                </div>
            </div>
        </div>
